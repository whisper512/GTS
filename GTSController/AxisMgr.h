...
// ============================================================
// AxisMgr — 单轴管理器
// 职责:单轴的使能/禁止、停止、报警/限位、状态、模式、软限位、跟随误差等
// 支持最多 8 个轴（GTS-400 系列支持4轴,保留扩展）
// ============================================================
...
public:
    ...
    // 设置/获取轴总数
    void setAxisCount(short count) { m_axisCount = count; }
    short axisCount() const { return m_axisCount; }
