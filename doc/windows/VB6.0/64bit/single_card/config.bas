...
Public Declare Function GT_SetDiConfig Lib "gts.dll" (ByVal diType As Integer, ByVal diIndex As Integer, ByRef pDi As TDiConfig) As Integer
Public Declare Function GT_GetDiConfig Lib "gts.dll" (ByVal diType As Integer, ByVal diIndex As Integer, ByRef pDi As TDiConfig) As Integer
Public Declare Function GT_SetDoConfig Lib "gts.dll" (ByVal doType As Integer, ByVal doIndex As Integer, ByRef pDo As TDoConfig) As Integer
Public Declare Function GT_GetDoConfig Lib "gts.dll" (ByVal doType As Integer, ByVal doIndex As Integer, ByRef pDo As TDoConfig) As Integer
Public Declare Function GT_SetStepConfig Lib "gts.dll" (ByVal mcStep As Integer, ByRef pStep As TStepConfig) As Integer
Public Declare Function GT_GetStepConfig Lib "gts.dll" (ByVal mcStep As Integer, ByRef pStep As TStepConfig) As Integer
Public Declare Function GT_SetDacConfig Lib "gts.dll" (ByVal dac As Integer, ByRef pDac As TDacConfig) As Integer
Public Declare Function GT_GetDacConfig Lib "gts.dll" (ByVal dac As Integer, ByRef pDac As TDacConfig) As Integer
Public Declare Function GT_SetCountConfig Lib "gts.dll" (ByVal countType As Integer, ByVal countIndex As Integer, ByRef pCount As TCountConfig) As Integer
Public Declare Function GT_GetCountConfig Lib "gts.dll" (ByVal countType As Integer, ByVal countIndex As Integer, ByRef pCount As TCountConfig) As Integer
Public Declare Function GT_SetControlConfig Lib "gts.dll" (ByVal control As Integer, ByRef pControl As TControlConfig) As Integer
Public Declare Function GT_GetControlConfig Lib "gts.dll" (ByVal control As Integer, ByRef pControl As TControlConfig) As Integer
Public Declare Function GT_SetProfileConfig Lib "gts.dll" (ByVal profile As Integer, ByRef pProfile As TProfileConfig) As Integer
Public Declare Function GT_GetProfileConfig Lib "gts.dll" (ByVal profile As Integer, ByRef pProfile As TProfileConfig) As Integer
Public Declare Function GT_SetAxisConfig Lib "gts.dll" (ByVal axis As Integer, ByRef pAxis As TAxisConfig) As Integer
Public Declare Function GT_GetAxisConfig Lib "gts.dll" (ByVal axis As Integer, ByRef pAxis As TAxisConfig) As Integer
Public Declare Function GT_GetConfigTable Lib "gts.dll" (ByVal type1 As Integer, ByRef pCount As Integer) As Integer
Public Declare Function GT_GetConfigTableAll Lib "gts.dll" () As Integer

Public Declare Function GT_SetMcConfig Lib "gts.dll" (ByRef pMc As TMcConfig) As Integer
Public Declare Function GT_GetMcConfig Lib "gts.dll" (ByRef pMc As TMcConfig) As Integer

Public Declare Function GT_SetMcConfigToFile Lib "gts.dll" (ByRef pMc As TMcConfig, ByVal pFile As String) As Integer
Public Declare Function GT_GetMcConfigFromFile Lib "gts.dll" (ByRef pMc As TMcConfig, ByVal pFile As String) As Integer

Public Declare Function GT_SaveConfig Lib "gts.dll" (ByVal pFile As String) As Integer

Public Declare Function GT_GetInterruptTime Lib "gts.dll" (ByRef pServoRunTime As Double, ByRef pProfileRunTime As Double) As Integer
Public Declare Function GT_GetInterruptTimeMax Lib "gts.dll" (ByRef pServoRunTimeMax As Double, ByRef pProfileRunTimeMax As Double) As Integer
...
Public Declare Function GT_ClearWatch Lib "gts.dll" (ByVal mode As Integer) As Integer
Public Declare Function GT_AddWatchVar Lib "gts.dll" (ByRef pVar As TWatchVar) As Integer
Public Declare Function GT_AddWatchEvent Lib "gts.dll" (ByRef pEvent As TWatchEvent) As Integer
Public Declare Function GT_WatchOn Lib "gts.dll" (ByVal interval As Integer, ByVal mode As Integer, ByVal count As Integer) As Integer
Public Declare Function GT_WatchOff Lib "gts.dll" () As Integer
Public Declare Function GT_PrintWatch Lib "gts.dll" (ByVal pFileName As String, ByVal start As Long, ByVal printCount As Long) As Integer
Public Declare Function GT_GetMcVar Lib "gts.dll" (ByRef pVar As TWatchVar, ByRef pValue As Double) As Integer

Public Declare Function GT_SetWatchGroup Lib "gts.dll" (ByVal group As Integer) As Integer
Public Declare Function GT_GetWatchGroup Lib "gts.dll" (ByRef pGroup As Integer) As Integer
Public Declare Function GT_LoadWatchConfig Lib "gts.dll" (ByVal pFile As String) As Integer
Public Declare Function GT_SaveWatchConfig Lib "gts.dll" (ByVal group As Integer, ByVal pFile As String) As Integer
Public Declare Function GT_ReadWatch Lib "gts.dll" (ByVal varIndex As Integer, ByRef pBuffer As Double, ByVal bufferSize As Long, ByRef pReadCount As Long) As Integer
...
Public Declare Function GT_GetWatchInfo Lib "gts.dll" (ByRef pInfo As TWatchInfo) As Integer
Public Declare Function GT_GetWatchVar Lib "gts.dll" (ByVal index As Integer, ByRef pVar As TWatchVar, ByRef pVarInfo As TWatchVarInfo) As Integer
Public Declare Function GT_GetWatchEvent Lib "gts.dll" (ByVal index As Integer, ByRef pEvent As TWatchEvent) As Integer
Public Declare Function GT_SetWatchFormat Lib "gts.dll" (ByRef pFormat As TWatchFormat) As Integer
Public Declare Function GT_GetWatchFormat Lib "gts.dll" (ByRef pFormat As TWatchFormat) As Integer
...
Public Declare Function GT_ClearEvent Lib "gts.dll" () As Integer
Public Declare Function GT_ClearTask Lib "gts.dll" () As Integer
Public Declare Function GT_ClearEventTaskLink Lib "gts.dll" () As Integer
Public Declare Function GT_AddEvent Lib "gts.dll" (ByRef pEvent As TEvent, pEventIndex As Integer) As Integer
Public Declare Function GT_AddTask Lib "gts.dll" (ByVal taskType As Integer, ByRef pTaskData As Long, ByRef pTaskIndex As Integer) As Integer
Public Declare Function GT_AddEventTaskLink Lib "gts.dll" (ByVal eventIndex As Integer, ByVal taskIndex As Integer, ByRef pLinkIndex As Integer) As Integer
Public Declare Function GT_GetEventCount Lib "gts.dll" (ByRef pCount As Integer) As Integer
Public Declare Function GT_GetEvent Lib "gts.dll" (ByVal eventIndex As Integer, ByRef pEvent As TEvent) As Integer
Public Declare Function GT_GetEventLoop Lib "gts.dll" (ByVal eventIndex As Integer, ByRef pCount As Long) As Integer
Public Declare Function GT_GetTaskCount Lib "gts.dll" (ByRef pCount As Integer) As Integer
Public Declare Function GT_GetTask Lib "gts.dll" (ByVal taskIndex As Integer, ByRef pTaskType As Integer, ByRef pTaskData As Long) As Integer
Public Declare Function GT_GetEventTaskLinkCount Lib "gts.dll" (ByRef pCount As Integer) As Integer
Public Declare Function GT_GetEventTaskLink Lib "gts.dll" (ByVal linkIndex As Integer, ByRef pEventIndex As Integer, ByRef pTaskIndex As Integer) As Integer
Public Declare Function GT_EventOn Lib "gts.dll" (ByVal eventIndex As Integer, ByVal count As Integer) As Integer
Public Declare Function GT_EventOff Lib "gts.dll" (ByVal eventIndex As Integer, ByVal count As Integer) As Integer
Public Declare Function GT_BufEventOn Lib "gts.dll" (ByVal crd As Integer, ByVal eventIndex As Integer, ByVal count As Integer, ByVal fifo As Integer) As Integer
Public Declare Function GT_BufEventOff Lib "gts.dll" (ByVal crd As Integer, ByVal eventIndex As Integer, ByVal count As Integer, ByVal fifo As Integer) As Integer
...
Public Declare Function GT_ClearVar Lib "gts.dll" () As Integer
Public Declare Function GT_SetVarBoolCondition Lib "gts.dll" (ByVal varIndex As Integer, ByRef pWatchCondition As TWatchCondition) As Integer
Public Declare Function GT_GetVarBoolCondition Lib "gts.dll" (ByVal varIndex As Integer, ByRef pWatchCondition As TWatchCondition) As Integer
Public Declare Function GT_AddVarCalculate Lib "gts.dll" (ByRef pVarCalculate As TVarCalculate, ByRef pIndex As Integer) As Integer
Public Declare Function GT_GetVarCalculateCount Lib "gts.dll" (ByRef pCount As Integer) As Integer
Public Declare Function GT_GetVarCalculate Lib "gts.dll" (ByVal index As Integer, ByRef pVarCalculate As TVarCalculate) As Integer
...
Public Declare Function GT_AddWatchVarEx Lib "gts.dll" (ByRef pVar As TWatchVarEx) As Integer