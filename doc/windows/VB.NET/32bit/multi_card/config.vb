Module gts_cfg
    ...
    Public Declare Function GT_SetDiConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal diType As Short, ByVal diIndex As Short, ByRef pDi As TDiConfig) As Short
    Public Declare Function GT_GetDiConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal diType As Short, ByVal diIndex As Short, ByRef pDi As TDiConfig) As Short
    Public Declare Function GT_SetDoConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal doType As Short, ByVal doIndex As Short, ByRef pDo As TDoConfig) As Short
    Public Declare Function GT_GetDoConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal doType As Short, ByVal doIndex As Short, ByRef pDo As TDoConfig) As Short
    Public Declare Function GT_SetStepConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal mcStep As Short, ByRef pStep As TStepConfig) As Short
    Public Declare Function GT_GetStepConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal mcStep As Short, ByRef pStep As TStepConfig) As Short
    Public Declare Function GT_SetDacConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal dac As Short, ByRef pDac As TDacConfig) As Short
    Public Declare Function GT_GetDacConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal dac As Short, ByRef pDac As TDacConfig) As Short
    Public Declare Function GT_SetCountConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal countType As Short, ByVal countIndex As Short, ByRef pCount As TCountConfig) As Short
    Public Declare Function GT_GetCountConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal countType As Short, ByVal countIndex As Short, ByRef pCount As TCountConfig) As Short
    Public Declare Function GT_SetControlConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal control As Short, ByRef pControl As TControlConfig) As Short
    Public Declare Function GT_GetControlConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal control As Short, ByRef pControl As TControlConfig) As Short
    Public Declare Function GT_SetProfileConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByRef pProfile As TProfileConfig) As Short
    Public Declare Function GT_GetProfileConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByRef pProfile As TProfileConfig) As Short
    Public Declare Function GT_SetAxisConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal axis As Short, ByRef pAxis As TAxisConfig) As Short
    Public Declare Function GT_GetAxisConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal axis As Short, ByRef pAxis As TAxisConfig) As Short
    Public Declare Function GT_GetConfigTable Lib "gts.dll" (ByVal cardNum As Short,ByVal type As Short, ByRef pCount As Short) As Short
    Public Declare Function GT_GetConfigTableAll Lib "gts.dll" (ByVal cardNum As Short) As Short

    Public Declare Function GT_SetMcConfig Lib "gts.dll" (ByVal cardNum As Short,ByRef pMc As TMcConfig) As Short
    Public Declare Function GT_GetMcConfig Lib "gts.dll" (ByVal cardNum As Short,ByRef pMc As TMcConfig) As Short

    Public Declare Function GT_SetMcConfigToFile Lib "gts.dll" (ByVal cardNum As Short,ByRef pMc As TMcConfig, ByVal pFile As String) As Short
    Public Declare Function GT_GetMcConfigFromFile Lib "gts.dll" (ByVal cardNum As Short,ByRef pMc As TMcConfig, ByVal pFile As String) As Short

    Public Declare Function GT_SaveConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal pFile As String) As Short

    Public Declare Function GT_GetInterruptTime Lib "gts.dll" (ByVal cardNum As Short,ByRef pServoRunTime As Double, ByRef pProfileRunTime As Double) As Short
    Public Declare Function GT_GetInterruptTimeMax Lib "gts.dll" (ByVal cardNum As Short,ByRef pServoRunTimeMax As Double, ByRef pProfileRunTimeMax As Double) As Short
    ...
    Public Declare Function GT_ClearWatch Lib "gts.dll" (ByVal cardNum As Short,ByVal mode As Short) As Short
    Public Declare Function GT_AddWatchVar Lib "gts.dll" (ByVal cardNum As Short,ByRef pVar As TWatchVar) As Short
    Public Declare Function GT_AddWatchEvent Lib "gts.dll" (ByVal cardNum As Short,ByRef pEvent As TWatchEvent) As Short
    Public Declare Function GT_WatchOn Lib "gts.dll" (ByVal cardNum As Short,ByVal interval As Short, ByVal mode As Short, ByVal count As Short) As Short
    Public Declare Function GT_WatchOff Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_PrintWatch Lib "gts.dll" (ByVal cardNum As Short,ByVal pFileName As String, ByVal start As Integer, ByVal printCount As UInteger) As Short
    Public Declare Function GT_GetMcVar Lib "gts.dll" (ByVal cardNum As Short,ByRef pVar As TWatchVar, ByRef pValue As Double) As Short

    Public Declare Function GT_SetWatchGroup Lib "gts.dll" (ByVal cardNum As Short,ByVal group As Short) As Short
    Public Declare Function GT_GetWatchGroup Lib "gts.dll" (ByVal cardNum As Short,ByRef pGroup As Short) As Short
    Public Declare Function GT_LoadWatchConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal pFile As String) As Short
    Public Declare Function GT_SaveWatchConfig Lib "gts.dll" (ByVal cardNum As Short,ByVal group As Short, ByVal pFile As String) As Short
    Public Declare Function GT_ReadWatch Lib "gts.dll" (ByVal cardNum As Short,ByVal varIndex As Short, ByRef pBuffer As Double, ByVal bufferSize As UInteger, ByRef pReadCount As UInteger) As Short
    ...
    Public Declare Function GT_GetWatchInfo Lib "gts.dll" (ByVal cardNum As Short,ByRef pInfo As TWatchInfo) As Short
    Public Declare Function GT_GetWatchVar Lib "gts.dll" (ByVal cardNum As Short,ByVal index As Short, ByRef pVar As TWatchVar, ByRef pVarInfo As TWatchVarInfo) As Short
    Public Declare Function GT_GetWatchEvent Lib "gts.dll" (ByVal cardNum As Short,ByVal index As Short, ByRef pEvent As TWatchEvent) As Short
    Public Declare Function GT_SetWatchFormat Lib "gts.dll" (ByVal cardNum As Short,ByRef pFormat As TWatchFormat) As Short
    Public Declare Function GT_GetWatchFormat Lib "gts.dll" (ByVal cardNum As Short,ByRef pFormat As TWatchFormat) As Short
    ...
    Public Declare Function GT_ClearEvent Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_ClearTask Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_ClearEventTaskLink Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_AddEvent Lib "gts.dll" (ByVal cardNum As Short,ByRef pEvent As TEvent, ByVal pEventIndex As Short) As Short
    Public Declare Function GT_AddTask Lib "gts.dll" (ByVal cardNum As Short,ByVal taskType As Short,ByVal pTaskData As Integer, ByRef pTaskIndex As Short) As Short
    Public Declare Function GT_AddEventTaskLink Lib "gts.dll" (ByVal cardNum As Short,ByVal eventIndex As Short, ByVal taskIndex As Short, ByRef pLinkIndex As Short) As Short
    Public Declare Function GT_GetEventCount Lib "gts.dll" (ByVal cardNum As Short,ByRef pCount As Short) As Short
    Public Declare Function GT_GetEvent Lib "gts.dll" (ByVal cardNum As Short,ByVal eventIndex As Short, ByRef pEvent As TEvent) As Short
    Public Declare Function GT_GetEventLoop Lib "gts.dll" (ByVal cardNum As Short,ByVal eventIndex As Short, ByRef pCount As UInteger) As Short
    Public Declare Function GT_GetTaskCount Lib "gts.dll" (ByVal cardNum As Short,ByRef pCount As Short) As Short
    Public Declare Function GT_GetTask Lib "gts.dll" (ByVal cardNum As Short,ByVal taskIndex As Short, ByRef pTaskType As Short, ByVal pTaskData As Integer) As Short
    Public Declare Function GT_GetEventTaskLinkCount Lib "gts.dll" (ByVal cardNum As Short,ByRef pCount As Short) As Short
    Public Declare Function GT_GetEventTaskLink Lib "gts.dll" (ByVal cardNum As Short,ByVal linkIndex As Short, ByRef pEventIndex As Short, ByRef pTaskIndex As Short) As Short
    Public Declare Function GT_EventOn Lib "gts.dll" (ByVal cardNum As Short,ByVal eventIndex As Short, ByVal count As Short) As Short
    Public Declare Function GT_EventOff Lib "gts.dll" (ByVal cardNum As Short,ByVal eventIndex As Short, ByVal count As Short) As Short
    Public Declare Function GT_BufEventOn Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal eventIndex As Short, ByVal count As Short, ByVal fifo As Short) As Short
    Public Declare Function GT_BufEventOff Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal eventIndex As Short, ByVal count As Short, ByVal fifo As Short) As Short
    ...
    Public Declare Function GT_ClearVar Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_SetVarBoolCondition Lib "gts.dll" (ByVal cardNum As Short,ByVal varIndex As Short, ByRef pWatchCondition As TWatchCondition) As Short
    Public Declare Function GT_GetVarBoolCondition Lib "gts.dll" (ByVal cardNum As Short,ByVal lvarIndex As Short, ByRef pWatchCondition As TWatchCondition) As Short
    Public Declare Function GT_AddVarCalculate Lib "gts.dll" (ByVal cardNum As Short,ByRef pVarCalculate As TVarCalculate, ByRef pIndex As Short) As Short
    Public Declare Function GT_GetVarCalculateCount Lib "gts.dll" (ByVal cardNum As Short,ByRef pCount As Short) As Short
    Public Declare Function GT_GetVarCalculate Lib "gts.dll" (ByVal cardNum As Short,ByVal index As Short, ByRef pVarCalculate As TVarCalculate) As Short
