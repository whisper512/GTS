Module gts_la
    ...
    Public Declare Function GT_InitLookAheadPara Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal lookAheadNum As Integer, ByVal time As Double, ByVal radiusRatio As Double, ByVal scale As Double, ByVal fifo As Short) As Short
