Module gts
   ...
   Public Structure TCrdSmoothInfo
    ...
    Public Declare Function GT_GetDllVersion Lib "gts.dll" (ByVal cardNum As Short, ByRef pDllVersion As String) As Short
    ...
    Public Declare Function GT_ZeroGantryPos Lib "gts.dll" (ByVal cardNum As Short,ByVal gantryMaster As Short,ByVal gantrySlave As Short) As Short
    ...
    Public Declare Function GT_SetPtPrecisionMode Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByVal precisionMode As Short ) As Short
    Public Declare Function GT_GetPtPrecisionMode Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByRef pPrecisionMode As Short) As Short
    Public Declare Function GT_SetPtVel Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByVal velLast As Double, ByVal fifo As Short) As Short
    Public Declare Function GT_SetPtLink Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByVal fifo As Short, ByVal list As Short) As Short
    Public Declare Function GT_GetPtLink Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByVal fifo As Short, ByRef pList As Short) As Short
    Public Declare Function GT_PtDoBit Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByVal doType As Short, ByVal doType As Short, ByVal index As Short, ByVal value As Short, ByVal fifo As Short) As Short
    Public Declare Function GT_PtAo Lib "gts.dll" (ByVal cardNum As Short,ByVal profile As Short, ByVal aoType As Short, ByVal index As Short, ByVal value As Short, ByVal fifo As Short) As Short
    ...
    Public Declare Function GT_GetVarValue Lib "gts.dll" (ByVal cardNum As Short, ByVal page As Short, ByRef pVarInfo As TVarInfo, ByRef pValue As Double, Optional ByVal count As Short = 1) As Short
		...
		Public Declare Function GT_SetCrdMapBase Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal base As Short) As Short
		Public Declare Function GT_GetCrdMapBase Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByRef pBase As Short) As Short
		Public Declare Function GT_SetCrdSmooth Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByRef pCrdSmooth As TCrdSmooth) As Short
		Public Declare Function GT_GetCrdSmooth Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByRef pCrdSmooth As TCrdSmooth) As Short
		Public Declare Function GT_SetCrdJerk Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal jerkMax As Double) As Short
		Public Declare Function GT_GetCrdJerk Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByRef pJerkMax As Double) As Short
    ...
    Public Declare Function GT_SetArcAllowError Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal error1 As Double) As Short
    ...
    Public Declare Function GT_CrdData Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal pCrdData As Integer, Optional ByVal fifo As Short = 0) As Short
    ...
    Public Declare Function GT_HelixZXCYOverride2WN Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal x As Integer, ByVal y As Integer, ByVal z As Integer, ByVal zCenter As Double, ByVal xCenter As Double, ByVal radius As Short, ByVal synVel As Double, ByVal synAcc As Double, Optional ByVal velEnd As Double = 0, Optional ByVal segNum As Integer = 0, Optional ByVal fifo As Short = 0) As Short
		Public Declare Function GT_BufTrend Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal trendSegNum As Integer, ByVal trendDistance As Double, ByVal trendVelEnd As Double, Optional ByVal fifo As Short = 0) As Short
    ...
    Public Declare Function GT_GetCmdCount Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByRef pResult As Short, ByVal fifo As Short) As Short
    ...
    Public Declare Function GT_BufLaserFollowOff Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, Optional ByVal fifo As Short = 0, Optional ByVal channel As Short = 0) As Short
    Public Declare Function GT_BufLaserFollowSpline Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal tableId As Short, ByVal minPower As Double, ByVal maxPower As Double, Optional ByVal fifo As Short = 0, Optional ByVal channel As Short = 0) As Short
    ...
    Public Declare Function GT_GetTriggerStatusEx Lib "gts.dll" (ByVal cardNum As Short, ByVal i As Short, ByRef pTriggerStatusEx As TTriggerStatusEx, Optional ByVal count As Short = 1) As Short
    ...
    Public Declare Function GT_CompareData Lib "gts.dll" (ByVal cardNum As Short, ByVal encoder As Short, ByVal source As Short, ByVal pulseType As Short, ByVal startLevel As Short, ByVal time As Short, ByVal pBuf1() As Integer, ByVal count1 As Short, ByVal pBuf2() As Integer, ByVal count2 As Short) As Short
    ...
    Public Declare Function GT_CompareContinuePulseMode Lib "gts.dll" (ByVal cardNum As Short, ByVal mode As Short, ByVal count As Short, ByVal standTime As Short) As Short
    ...
    Public Declare Function GT_2DCompareClearData Lib "gts.dll" (ByVal cardNum As Short,ByVal chn As Short) As Short
    Public Declare Function GT_2DCompareSetPreOutTime Lib "gts.dll" (ByVal cardNum As Short,ByVal chn As Short, ByVal preOutputTime As Double) As Short
    ...
    Public Declare Function GT_SetLaserFollowSpline Lib "gts.dll" (ByVal cardNum As Short, ByVal tableId As Short, ByVal n As Integer, ByRef pX As Double, ByRef pY As Double, ByVal beginValue As Double, ByVal endValue As Double, Optional ByVal channel As Short = 0) As Short
    Public Declare Function GT_GetLaserFollowSpline Lib "gts.dll" (ByVal cardNum As Short, ByVal tableId As Short, ByVal n As Integer, ByRef pX As Double, ByRef pY As Double, ByRef pA As Double, ByRef pB As Double, ByRef pC As Double, ByRef pCount As Integer, Optional ByVal channel As Short = 0) As Short

    'ExtMul
    Public Declare Function GT_OpenExtMdl Lib "gts.dll" (ByVal cardNum As Short, Optional ByRef pDllName As String = Nothing) As Short
    Public Declare Function GT_CloseExtMdl Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_SwitchtoCardNoExtMdl Lib "gts.dll" (ByVal cardNum As Short, ByVal card As Short) As Short
    Public Declare Function GT_ResetExtMdl Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_LoadExtConfig Lib "gts.dll" (ByVal cardNum As Short, ByRef pFileName As String) As Short
    Public Declare Function GT_SetExtIoValue Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal value As UShort) As Short
    Public Declare Function GT_GetExtIoValue Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByRef pValue As UShort) As Short
    Public Declare Function GT_SetExtIoBit Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal index As Short, ByVal value As UShort) As Short
    Public Declare Function GT_GetExtIoBit Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal index As Short, ByRef pValue As UShort) As Short
    Public Declare Function GT_GetExtAdValue Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal chn As Short, ByRef pValue As UShort) As Short
    Public Declare Function GT_GetExtAdVoltage Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal chn As Short, ByRef pValue As Double) As Short
    Public Declare Function GT_SetExtDaValue Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal chn As Short, ByVal value As UShort) As Short
    Public Declare Function GT_SetExtDaVoltage Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal chn As Short, ByVal value As Double) As Short
    Public Declare Function GT_GetStsExtMdl Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByVal chn As Short, ByRef pStatus As UShort) As Short
    Public Declare Function GT_GetExtDoValue Lib "gts.dll" (ByVal cardNum As Short, ByVal mdl As Short, ByRef pValue As UShort) As Short
    Public Declare Function GT_GetExtMdlMode Lib "gts.dll" (ByVal cardNum As Short, ByRef pMode As Short) As Short
    Public Declare Function GT_SetExtMdlMode Lib "gts.dll" (ByVal cardNum As Short, ByVal mode As Short) As Short
    Public Declare Function GT_UploadConfig Lib "gts.dll" (ByVal cardNum As Short) As Short
    Public Declare Function GT_DownloadConfig Lib "gts.dll" (ByVal cardNum As Short) As Short
    
    Public Declare Function GT_GetUuid Lib "gts.dll" (ByVal cardNum As Short,ByRef pCode As String, ByVal count As Short) As Short
    Public Declare Function GT_SetUuid Lib "gts.dll" (ByVal cardNum As Short,ByRef pCode As String, ByVal count As Short) As Short
    ...
    End Structure
    Public Declare Function GT_SetCompensate2DTable Lib "gts.dll" (ByVal cardNum As Short, ByVal tableIndex As Short, ByRef pTable As TCompensate2DTable, ByRef pData As Integer, Optional ByVal externComp As Short = 0) As Short
    Public Declare Function GT_GetCompensate2DTable Lib "gts.dll" (ByVal cardNum As Short, ByVal tableIndex As Short, ByRef pTable As TCompensate2DTable, Optional ByRef pExternComp As Short = Nothing) As Short
    Public Declare Function GT_SetCompensate2D Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pComp2d As TCompensate2D) As Short
    Public Declare Function GT_GetCompensate2D Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pComp2d As TCompensate2D) As Short
    Public Declare Function GT_GetCompensate2DValue Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pValue As Double) As Short
    ...
    Public Declare Function GT_GoHome Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pHomePrm As THomePrm) As Short
    Public Declare Function GT_GetHomePrm Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pHomePrm As THomePrm) As Short
    Public Declare Function GT_GetHomeStatus Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pHomeStatus As THomeStatus) As Short
    ...
    End Structure
    Public Declare Function GT_SetControlConfigEx Lib "gts.dll" (ByVal cardNum As Short, ByVal control As Short, ByRef pControl As TControlConfigEx) As Short
    Public Declare Function GT_GetControlConfigEx Lib "gts.dll" (ByVal cardNum As Short, ByVal control As Short, ByRef pControl As TControlConfigEx) As Short
    ...
    End Structure
    Public Declare Function GT_SetAdcConfig Lib "gts.dll" (ByVal cardNum As Short, ByVal adc As Short, ByRef pAdc As TAdcConfig) As Short
    Public Declare Function GT_GetAdcConfig Lib "gts.dll" (ByVal cardNum As Short, ByVal adc As Short, ByRef pAdc As TAdcConfig) As Short
    Public Declare Function GT_SetAdcFilterPrm Lib "gts.dll" (ByVal cardNum As Short, ByVal adc As Short, ByVal k As Double) As Short
    Public Declare Function GT_GetAdcFilterPrm Lib "gts.dll" (ByVal cardNum As Short, ByVal adc As Short, ByRef pk As Double) As Short

    'Superimposed
    Public Declare Function GT_SetControlSuperimposed Lib "gts.dll" (ByVal cardNum As Short, ByVal control As Short, ByVal superimposedType As Short, ByVal superimposedIndex As Short) As Short
    Public Declare Function GT_GetControlSuperimposed Lib "gts.dll" (ByVal cardNum As Short, ByVal control As Short, ByRef pSuperimposedType As Short, ByRef pSuperimposedIndex As Short) As Short

    ''
    Public Declare Function GT_ZeroLaserOnTime Lib "gts.dll" (ByVal cardNum As Short, ByVal channel As Short) As Short
    Public Declare Function GT_GetLaserOnTime Lib "gts.dll" (ByVal cardNum As Short, ByVal channel As Short, ByRef pTime As UInteger) As Short
    
    Public Declare Function GT_SetProfileScale Lib "gts.dll" (ByVal cardNum As Short,ByVal axis As Short, ByVal alpha As Integer, ByVal beta As Integer) As Short
		Public Declare Function GT_GetProfileScale Lib "gts.dll" (ByVal cardNum As Short,ByVal axis As Short, ByRef pAlpha As Integer, ByRef pBeta As Integer) As Short
		Public Declare Function GT_SetEncoderScale Lib "gts.dll" (ByVal cardNum As Short,ByVal encoder As Short, ByVal alpha As Integer, ByVal beta As Integer) As Short
		Public Declare Function GT_GetEncoderScale Lib "gts.dll" (ByVal cardNum As Short,ByVal encoder As Short, ByRef pAlpha As Integer, ByRef pBeta As Integer) As Short
		
		Public Declare Function GT_MultiAxisOn Lib "gts.dll" (ByVal cardNum As Short,ByVal mask As Integer) As Short
		Public Declare Function GT_MultiAxisOff Lib "gts.dll" (ByVal cardNum As Short,ByVal mask As Integer) As Short
		Public Declare Function GT_SetAxisOnDelayTime Lib "gts.dll" (ByVal cardNum As Short,ByVal ms As UShort) As Short
		Public Declare Function GT_GetAxisOnDelayTime Lib "gts.dll" (ByVal cardNum As Short,ByRef pMs As UShort) As Short
		
		Public Declare Function GT_SetLaserDisTable1D Lib "gts.dll" (ByVal cardNum As Short,ByVal count As Short, ByRef pRatio As Double, ByRef pPos As Double, ByVal minPower As Double, ByVal maxPower As Double,ByRef pLimitPower As Double, Optional ByVal channel As Short = 0) As Short
		Public Declare Function GT_SetLaserDisTable2D Lib "gts.dll" (ByVal cardNum As Short,ByRef axisIndex As Short, ByRef count As Short, ByRef pRatio As Double, ByRef pXPos As Integer, ByRef pYPos As Integer,ByVal minPower As Double, ByVal maxPower As Double, ByRef pLimitPower As Double, Optional ByVal channel As Short = 0) As Short
		Public Declare Function GT_SetLaserDisTable2DEx Lib "gts.dll" (ByVal cardNum As Short,ByRef axisIndex As Short, ByRef count As Short, ByRef pRatio As Double, ByRef posBegin As Integer, ByRef posStep As Integer,ByVal minPower As Double, ByVal maxPower As Double, ByRef pLimitPower As Double, Optional ByVal channel As Short = 0) As Short
		
		Public Declare Function GT_SetLaserCrdMap Lib "gts.dll" (ByVal cardNum As Short,ByVal channel As Short, ByVal map As Short) As Short
		Public Declare Function GT_GetLaserCrdMap Lib "gts.dll" (ByVal cardNum As Short,ByVal channel As Short, ByRef pMap As Short) As Short
		
		'AutoFocus
		Public Declare Function GT_AutoFocus Lib "gts.dll" (ByVal cardNum As Short,ByVal mode As UShort, ByVal kp As Double, ByVal reverse As Short, ByVal channel As Short) As Short
		Public Declare Function GT_SetAutoFocusRefVol Lib "gts.dll" (ByVal cardNum As Short,ByVal refVol As Double, ByVal maxVol As Double, ByVal minVol As Double, ByVal channel As Short) As Short
		Public Declare Function GT_GetAutoFocusStatus Lib "gts.dll" (ByVal cardNum As Short,ByRef pStatus As UShort, ByVal count As Short) As Short
		Public Declare Function GT_ConfigAutoFocus Lib "gts.dll" (ByVal cardNum As Short,ByVal chnAdc As Short, ByVal channel As Short) As Short
		Public Declare Function GT_SetAutoFocusAuxPrm Lib "gts.dll" (ByVal cardNum As Short,ByVal kf As Double, ByVal kd As Double, ByVal limitKd As Double, ByVal channel As Short) As Short
		
		Public Declare Function GT_Delay Lib "gts.dll" (ByVal cardNum As Short,ByVal time As UShort) As Short
		Public Declare Function GT_DelayHighPrecision Lib "gts.dll" (ByVal cardNum As Short,ByVal time As UShort) As Short

		Public Declare Function GT_SetCrdBufferMode Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal bufferMode As Short, ByVal fifo As Short) As Short
		Public Declare Function GT_GetCrdBufferMode Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByRef pBufferMode As Short, ByVal fifo As Short) As Short
		Public Declare Function GT_GetCrdSegmentTime Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByVal segmentIndex As Integer, ByRef pSegmentTime As Double, ByRef pSegmentNumber As Integer, ByVal fifo As Short) As Short
		Public Declare Function GT_GetCrdTime Lib "gts.dll" (ByVal cardNum As Short,ByVal crd As Short, ByRef pTime As TCrdTime, ByVal fifo As Short) As Short
		
		Public Declare Function GT_SetLeadScrewLink Lib "gts.dll" (ByVal cardNum As Short,ByVal axis As Short, ByVal link As Short) As Short
		Public Declare Function GT_GetLeadScrewLink Lib "gts.dll" (ByVal cardNum As Short,ByVal axis As Short, ByRef pLink As Short) As Short
    ...
    Public Declare Function GT_ExecuteStandardHome Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pHomePrm As TStandardHomePrm) As Short

    Public Declare Function GT_GetStandardHomePrm Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pHomePrm As TStandardHomePrm) As Short

    Public Declare Function GT_GetStandardHomeStatus Lib "gts.dll" (ByVal cardNum As Short, ByVal axis As Short, ByRef pHomeStatus As TStandardHomeStatus) As Short

    'DMA
    Public Declare Function GT_CrdHsOn Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal fifo As Short, ByVal link As Short, ByVal threshold As UShort, ByVal lookAheadInMc As Short) As Short

    Public Declare Function GT_CrdHsOff Lib "gts.dll" (ByVal cardNum As Short, ByVal crd As Short, ByVal fifo As Short) As Short
End Module
