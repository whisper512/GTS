...
namespace gts
{
    public class mc_cfg
	{
			...
			[DllImport("gts.dll")]
			public static extern short GT_PrintWatch(out char pFileName,int start,uint printCount);
			[DllImport("gts.dll")]
			...
			[DllImport("gts.dll")]
			public static extern short GT_AddTask(short taskType,System.IntPtr pTaskData,out short pTaskIndex);
			[DllImport("gts.dll")]
			...
			[DllImport("gts.dll")]
			public static extern short GT_GetEventLoop(short eventIndex,out int pCount); 
			[DllImport("gts.dll")]
