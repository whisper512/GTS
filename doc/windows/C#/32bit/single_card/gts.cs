...
namespace gts
{
	...
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowStart(short crd,int masterSegment,int slaveSegment,int masterFrameWidth,short fifo);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowReturn(short crd,double vel,double acc,short smoothPercent,short fifo);
	[DllImport("gts.dll")]
        public static extern short GT_BufFollowNext(short crd,int width,short fifo);
	[DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowStatus(short crd,out TCrdFollowStatus pStatus);
	[DllImport("gts.dll")]
        public static extern short GT_SetCrdFollowLoop(short crd,uint loop);
	[DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowLoop(short crd,out uint pLoop);
	[DllImport("gts.dll")]
